defmodule IntercomStatsWeb.PageController do
  ...
  defp model(from_date, to_date) do
    ...
    %{
      search: filter,
      average_response_time: Conversations.get_average(:time_to_first_response, conversations),
      average_closing_time: Conversations.get_average(:closing_time, conversations),
      averages_per_company: Conversations.conversation_averages_by_company(filter),
      number_of_messages: Conversations.get_number(conversations)
    }
  end
end
